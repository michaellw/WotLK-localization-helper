...
-- For extra localization

-- CharacterCreate.lua
_CLASS_DISABLED = "You must choose a different race to be this class.";
...
_ORC = "Orc";
_DWARF = "Dwarf";
_NIGHT_ELF = "Night Elf";
_UNDEAD = "Undead";
_TAUREN = "Tauren";
_GNOME = "Gnome";
_TROLL = "Troll";
_GOBLIN = "Goblin";
_BLOOD_ELF = "Blood Elf";
_DRAENEI = "Draenei";
_VOID_ELF = "Void Elf";
_VULPERA = "Vulpera";
_HIGH_ELF = "High Elf";
_PANDAREN = "Pandaren";
_WORGEN = "Worgen";
_EREDAR = "Man'ari Eredar";
_LIGHTFORGED = "Lightforged Draenei";
_DEMON_HUNTER = "Demon Hunter";
-- Pandaren
